...
class Intercom {
  ...
  Stream<dynamic> getUnreadStream() {
    return Intercom.instance.getUnreadStream();
  }
  ...
  Future<void> setBottomPadding(int padding) {
    return Intercom.instance.setBottomPadding(padding);
  }
  ...
  Future<void> setUserHash(String userHash) {
    return Intercom.instance.setUserHash(userHash);
  }
  ...
  Future<void> setLauncherVisibility(IntercomVisibility visibility) {
    return Intercom.instance.setLauncherVisibility(visibility);
  }
  ...
  Future<int> unreadConversationCount() {
    return Intercom.instance.unreadConversationCount();
  }
  ...
  Future<void> hideMessenger() {
    return Intercom.instance.hideMessenger();
  }
  ...
  Future<void> displayHelpCenter() {
    return Intercom.instance.displayHelpCenter();
  }
  ...
  Future<void> logEvent(String name, [Map<String, dynamic>? metaData]) {
    return Intercom.instance.logEvent(name, metaData);
  }
  ...
  Future<bool> isIntercomPush(Map<String, dynamic> message) async {
    return Intercom.instance.isIntercomPush(message);
  }
  ...
  Future<void> handlePush(Map<String, dynamic> message) async {
    return Intercom.instance.handlePush(message);
  }
  ...
  Future<void> displayArticle(String articleId) async {
    return Intercom.instance.displayArticle(articleId);
  }
  ...
  Future<void> displayCarousel(String carouselId) async {
    return Intercom.instance.displayCarousel(carouselId);
  }
  ...
  Future<void> displaySurvey(String surveyId) {
    return Intercom.instance.displaySurvey(surveyId);
  }
}